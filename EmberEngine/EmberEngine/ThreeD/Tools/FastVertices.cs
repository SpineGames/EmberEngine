...
namespace EmberEngine.ThreeD.Tools
{
    ...
    public static class FV
    {
        ...
        public static VertexPositionColorNormalTexture VPCNT
            (float X, float Y, float Z, float nX, float nY, float nZ, float tX, float tY, 
            Color color)
        {
            return new VertexPositionColorNormalTexture(new Vector3(X, Y, Z), new Vector3(nX, nY, nZ), new Vector2(tX, tY), color);
        }
        ...
        public static VertexPositionColorNormalTexture VPCNT
            ...
            Color color)
        {
            return new VertexPositionColorNormalTexture(new Vector3(X, Y, Z), Normal, TexCoords, color);
        }
        ...
        public static VertexPositionColorNormalTexture VPCNT
            ...
            Color color)
        {
            return new VertexPositionColorNormalTexture(Position, new Vector3(nX, nY, nZ), new Vector2(tX, tY), color);
        }
        ...
        public static VertexPositionColorNormalTexture VPCNT
            ...
            Color color)
        {
            return new VertexPositionColorNormalTexture(Position, Normal, new Vector2(tX, tY), color);
        }
        ...
        public static VertexPositionColorNormalTexture VPCNT
            ...
            Color color)
        {
            return new VertexPositionColorNormalTexture(Position, Normal, TexCoords, color);
        }
    }
}
