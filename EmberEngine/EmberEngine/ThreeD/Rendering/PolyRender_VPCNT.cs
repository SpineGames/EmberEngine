...
namespace EmberEngine.ThreeD.Rendering
{
    ...
    /// </summary>
    public class PolyRender_VPNTC : IRenderable
    {
        /// <summary>
        /// The buffer for all vertices
        /// </summary>
        VertexPositionNormalTextureColor[] Buffer = new VertexPositionNormalTextureColor[] { };
        /// <summary>
        ...
        public PolyRender_VPNTC(GraphicsDevice graphics)
        {
        ...
        public PolyRender_VPNTC(Shader shader)
        {
        ...
        {
            Temp.Clear();
            Buffer = new VertexPositionNormalTextureColor[0];
            Indices = new int[0];
        }
        ...
        public void AddPolys(VertexPositionNormalTextureColor[] buffer)
        {
        ...
        public void Render(ThreeDCamera view)
        {
            if (PrimitiveCount > 0)
            {
                ...
                foreach (EffectPass p in Effect.BaseEffect.CurrentTechnique.Passes)
                {
                    ...
                    Graphics.DrawUserIndexedPrimitives<VertexPositionNormalTextureColor>(
